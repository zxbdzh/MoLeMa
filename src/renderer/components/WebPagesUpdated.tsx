...
export default function WebPages() {
  ...
  const [selectedWebPage, setSelectedWebPage] = useState<WebPageItem | null>(null)
  ...
  const handleWebPageClick = (webPage: WebPageItem) => {
            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={\lex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors $\{selectedCategory === category.id
          ...
          {webPages.map((item) => {
            ...
            return (
              <div
                ...
                onClick={() => handleWebPageClick(item)}
            ...
            <div className=\"p-6 overflow-y-auto max-h-[calc(90vh-200px)]\">
              ...
              <div className=\"mb-6 p-6 bg-slate-50 dark:bg-slate-800/50 rounded-xl\">
                ...
                <div className=\"space-y-4\">
                  ...
                  {testResult && (
                    <div className={\lex items-center gap-2 p-3 rounded-lg $\{testResult.success
                        ...
                        <div className=\"flex items-center justify-between\">
                          <div className=\"flex-1 min-w-0\">
                            <div className=\"flex items-center gap-2 mb-1\">
                              ...
                              <span className={\px-2 py-0.5 rounded-full text-xs $\{webPage.is_active === 1
