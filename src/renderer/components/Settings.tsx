    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                {isRecording && (
                    <div
                        className="bg-purple-100 dark:bg-purple-900/30 border border-purple-300 dark:border-purple-500/30 rounded-xl p-4 text-center">
            ...
            <div className="space-y-4">
                ...
                <Card3D className="p-6">
                    <div className="space-y-4">
                        ...
                        <div
                            className="bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl p-4">
                        ...
                        {pathSaved && migrationResult && (
                            <div
                                className="bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-500/30 rounded-xl p-4">
                        ...
                        {pathSaved && !migrationResult && (
                            <div
                                className="bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-500/30 rounded-xl p-4 text-center">
                        ...
                        {pathError && (
                            <div
                                className="bg-red-100 dark:bg-red-900/30 border border-red-300 dark:border-red-500/30 rounded-xl p-4">
                        ...
                        <div
                            className="bg-blue-100 dark:bg-blue-900/30 border border-blue-300 dark:border-blue-500/20 rounded-xl p-4">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <input
                                    ...
                                    className="w-5 h-5 rounded border-slate-300 dark:border-slate-700 text-blue-600 focus:ring-blue-500 cursor-pointer"
                                />
                                <label htmlFor="auto-update-enabled"
                                       className="text-slate-700 dark:text-slate-300 cursor-pointer">
                                    启用自动更新
                                </label>
                            </div>
                ...
                <Card3D className="p-6">
                    <div className="space-y-4">
                        ...
                        <div className="bg-slate-100 dark:bg-slate-800 rounded-lg p-4">
                            ...
                            {updateInfo && (
                                <div className="flex items-center justify-between">
                                    ...
                                    <span
                                        className="text-sm font-medium dark:text-white text-slate-900">v{updateInfo.version}</span>
                                </div>
                            )}
                        </div>
                        ...
                        {updateStatus === 'available' && (
                            <div
                                className="bg-blue-100 dark:bg-blue-900/30 border border-blue-300 dark:border-blue-500/20 rounded-lg p-4">
                                <p className="text-sm dark:text-slate-300 text-slate-700">发现新版本
                                    v{updateInfo?.version}</p>
                            </div>
                        )}
                        ...
                        {updateStatus === 'downloaded' && (
                            <div
                                className="bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-500/20 rounded-lg p-4">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <input
                                    ...
                                    className="w-5 h-5 rounded border-slate-300 dark:border-slate-700 text-blue-600 focus:ring-blue-500 cursor-pointer"
                                />
                                <label htmlFor="auto-launch-enabled"
                                       className="text-slate-700 dark:text-slate-300 cursor-pointer">
                                    启用开机自启
                                </label>
                            </div>
