...
export default function RSSPage() {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
                ...
                <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex gap-2">
                        ...
                        >
                            ...
                            {favorites.length > 0 && (
                                <span
                                    className="bg-slate-200 dark:bg-slate-700/50 text-slate-900 dark:text-white px-2 py-0.5 rounded-full text-xs">
                  {favorites.length}
                </span>
                            )}
                        </button>
            ...
            {/* 添加 RSS 源 */}
            <div
                className="bg-slate-900/60 dark:bg-slate-900/60 bg-white/60 backdrop-blur-md rounded-xl p-6 border border-slate-700/50 dark:border-slate-700/50 border-slate-200 mb-8">
                        ...
                        {!currentFeed ? (
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <span
                                        className="text-sm text-slate-400 dark:text-slate-400 text-slate-600">{currentFeed.items.length} 篇文章</span>
                                </div>
