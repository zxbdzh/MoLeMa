...
import { getMainWindow, toggleWindow, minimizeWindow, maximizeWindow, closeWindow, toggleFullscreen, isFullscreen } from "./windowManager";
import { updateShortcuts, getShortcuts } from "./shortcutManager";
import { getAutoUpdateEnabled, setAutoUpdateEnabled, checkForUpdates } from "./autoUpdater";
import { notesApi } from "../api/notesApi";
import { todosApi } from "../api/todosApi";
import { webPagesApi } from "../api/webPagesApi";
import { recordingsApi } from "../api/recordingsApi";
import { getDatabase, getCurrentDatabasePath, setCustomDatabasePath, migrateDatabaseToNewPath, getProxy, setProxy, getProxyConfig } from "../database";
