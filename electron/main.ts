import { app, BrowserView, ipcMain, dialog } from "electron";
...
ipcMain.handle("browserView:create", async (_event, id: string, options?: any) => {
  try {
    ...
    const browserView = new BrowserView({
      webPreferences: { nodeIntegration: false, contextIsolation: true, webSecurity: true, sandbox: true, ...options?.webPreferences },
    });
